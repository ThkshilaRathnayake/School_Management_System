...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        ...
        <div class="col-lg-4">
            <form method="GET" action="{{ route('admin.searchCourseForTeacher') }}">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <nav class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><h6 class="card-title">Add Teachers</h6></li>
                            ...
                            <tbody>
                                @foreach ($courses as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.teacherListForCourses', ['courseId' => $item->courseID]) }}" class="btn btn-outline-primary">Add Teachers</a>
                                        </td>
                                    </tr>  
                                @endforeach
                            </tbody>
