...
<nav class="navbar">
    ...
    <div class="sidebar">
      <div class="sidebar-header">
        <a href="#" class="sidebar-brand">
          aaaaaaaaaaaaaaaaSchool<span>Management</span>System
        </a>
      </div>
    </div>
  ...
  <!--  <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="languageDropdown">
            ...
            <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-fr" title="fr" id="fr"></i> <span class="ms-1"> Sinhala </span></a>
            <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-de" title="de" id="de"></i> <span class="ms-1"> Tamil </span></a>
          </div>
        </li>  -->
